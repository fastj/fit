...
public class TestStep{
	...
	private List<String> outCmdLines = new ArrayList<String>();
	...
	public List<String> getOutCmdLines() {
		return outCmdLines;
	}
	
	public void addOut(String line)
	{
		if (!outCmdLines.contains(line))
		{
			outCmdLines.add(line);
		}
	}
	...
	public void mergeSResult(StepResult srlt)
	{
		results.add(srlt);
