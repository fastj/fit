...
public final class TSuite implements org.fastj.fit.intf.TSuite{
	...
	{
		try {
			Matcher m = Pattern.compile(TProject.NAME_REGEX).matcher(name);
			m.find();
	...
	private TSuite(String name, int l)
	{
		...
		if (l < 0 || l > 10000)
		{
			throw new IllegalArgumentException("TSuite level[0, 100] is invalid: " + level);
		}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof String || obj instanceof TSuite)
		{
