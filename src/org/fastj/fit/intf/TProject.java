...
public interface TProject {
	...
	String SETUP_FILE = "setup.script";
	String TS_NAME_REGEX = "^([\\S\\s]*)__L([0-9]{1,})\\.script$";
	String TC_NAME_REGEX = "^([\\S\\s]*)\\.fitc$";
	String TR_NAME_REGEX = "^([\\S\\s]*)\\.fitrun$";
